...
public class OIMForms extends BaseHelper {
    ...
    private static final Logger logger = Logger.getLogger(OIMForms.class.getName());
    ...
    public OIMForms(OIMClient client) throws OIMHelperException {
        ...
        if (formDefOp == null) {
            logger.log(Level.SEVERE,"Failed to get formDefOp");
            throw new OIMHelperException("formDefOp Failed");
        }
        if (formInstOp == null) {
            logger.log(Level.SEVERE,"Failed to get formInstOp");
    ...
    public int getFormVersion(long ProcessInstanceKey)  throws OIMHelperException {
        ...
        try {
            ...
            try {
                ...
                logger.log(Level.SEVERE,"tcVersionNotDefinedException",ex);
                throw new OIMHelperException("tcVersionNotDefinedException",ex);
            } catch (tcAPIException ex) {
                logger.log(Level.SEVERE,"tcAPIException",ex);
                throw new OIMHelperException("tcAPIException",ex);
            } catch (tcProcessNotFoundException ex) {
                logger.log(Level.SEVERE,"tcProcessNotFoundException",ex);
        ...
        logger.fine("Exiting OIMForms.getFormVersion():" + result);
        return result;
    ...
    public boolean isFieldType(String Field, String Type, int FormVersion, long FormDefKey) throws OIMHelperException {
        ...
        try {
            logger.fine("Entering OIMForms.isFieldType()");
            ...
            logger.log(Level.SEVERE,"tcColumnNotFoundException",ex);
            throw new OIMHelperException("tcColumnNotFoundException",ex);
        }
        logger.fine("Exiting OIMForms.isFieldType()");
        return result;
    }
    ...
    public Map getProcessFormValues(long ProcessInstanceKey, boolean HideEncrypted, String DateFormat) throws OIMHelperException {
        try {
            logger.fine("Entering OIMForms.getProcessFormValues()");
            ...
            if (results.getRowCount() == 1) {
                ...
                logger.log(Level.SEVERE,"Too Many Records for Instance " + ProcessInstanceKey);
                throw new OIMHelperException("Too many process instance results ", ProcessInstanceKey);
            }
            logger.fine("Exiting OIMForms.getProcessFormValues()");
            return result;
        } catch (tcColumnNotFoundException ex) {
            logger.log(Level.SEVERE,"tcColumnNotFoundException",ex);
            throw new OIMHelperException("tcColumnNotFoundException",ex);
    ...
    public void setProcessFormValue(long ProcessInstanceKey, String Attribute, String Value) throws OIMHelperException {
        ...
        logger.fine("Entering OIMForms.setProcessFormValue()");
        Map data = new HashMap();
        data.put(Attribute, Value);
        try {
            setProcessFormValues(ProcessInstanceKey, data);
        } catch (OIMHelperException ex) {
            logger.log(Level.SEVERE,"setProcessFormValue",ex);
            throw ex;
        }
        logger.fine("Exiting OIMForms.setProcessFormValue()");
    }
    ...
    public void setProcessFormValues(long ProcessInstanceKey, Map Data) throws OIMHelperException {
        try {
            logger.fine("Entering OIMForms.setProcessFormValues()");
            formInstOp.setProcessFormData(ProcessInstanceKey, Data);
            logger.fine("Exiting OIMForms.setProcessFormValues()");
        } catch (tcAPIException ex) {
            logger.log(Level.SEVERE,"tcAPIException",ex);
            throw new OIMHelperException("tcAPIException",ex);
        } catch (tcInvalidValueException ex) {
            logger.log(Level.SEVERE,"tcInvalidValueException",ex);
            ...
            logger.log(Level.SEVERE,"tcRequiredDataMissingException",ex);
    ...
    public Map getPrepopData(long ProcessInstanceKey, String dateFormat) throws OIMHelperException {
        try {
            logger.fine("Entering OIMForms.getPrepopData()");
            Map result = new HashMap();
            ...
            logger.fine("Exiting OIMForms.getPrepopData()");
            return result;
        } catch (tcProcessNotFoundException ex) {
            logger.log(Level.SEVERE,"tcProcessNotFoundException",ex);
            throw new OIMHelperException("tcProcessNotFoundException",ex);
    ...
    public long getChildFormDefKey(long ProcessInstanceKey, String ChildTable) throws OIMHelperException {
        ...
        logger.fine("Entering OIMForms.getChildFormDefKey()");
        long result = 0L;
        int formVersion;
        try {
            formVersion = getFormVersion(ProcessInstanceKey);
        } catch (OIMHelperException ex) {
            logger.log(Level.SEVERE,"getChildFormDefKey/getFormVersion",ex);
            throw ex;
        }
        try
        {
        ...
        logger.fine("Exiting OIMForms.getChildFormDefKey():" + result);
        return result;
    }
    ...
    public String[] getChildTables(long ProcessInstanceKey) throws OIMHelperException {
        try {
            logger.fine("Entering OIMForms.getChildTables()");
            int formVersion = getFormVersion(ProcessInstanceKey);
            long formDefKey = formInstOp.getProcessFormDefinitionKey(ProcessInstanceKey);
            tcResultSet childFormDefs = formInstOp.getChildFormDefinition(formDefKey, formVersion);
            ...
            logger.fine("Exiting OIMForms.getChildTables()");
            return result;
        } catch (tcColumnNotFoundException ex) {
            logger.log(Level.SEVERE,"tcColumnNotFoundException",ex);
            throw new OIMHelperException("tcColumnNotFoundException",ex);
    ...
    public Map[] getProcessFormChildValues(long ProcessInstanceKey, String ChildTable, boolean HideEncrypted, String DateFormat) throws OIMHelperException {
        try {
            logger.fine("Entering OIMForms.getProcessFormChildValues()");
            ...
            logger.fine("Exiting OIMForms.getProcessFormChildValues()");
            ...
            logger.log(Level.SEVERE,"getProcessFormChildValues",ex);
            throw ex;
        }
    ...
    public void addProcessFormChildValue(long ProcessInstanceKey, String ChildTable, Map Data) throws OIMHelperException {
        try {
            logger.fine("Entering OIMForms.addProcessFormChildValue()");
            long childDefKey = getChildFormDefKey(ProcessInstanceKey, ChildTable);
            formInstOp.addProcessFormChildData(childDefKey, ProcessInstanceKey, Data);
            logger.fine("Exiting OIMForms.addProcessFormChildValue()");
        } catch (tcProcessNotFoundException ex) {
            logger.log(Level.SEVERE,"tcProcessNotFoundException",ex);
            throw new OIMHelperException("tcProcessNotFoundException",ex);
        } catch (tcFormNotFoundException ex) {
    ...
    public void updateProcessFormChildValue(long ProcessInstanceKey, String ChildTable, long ChildDataKey, Map Data) throws OIMHelperException {
        try {
            logger.fine("Entering OIMForms.updateProcessFormChildValue()");
            long childDefKey = getChildFormDefKey(ProcessInstanceKey, ChildTable);
            formInstOp.updateProcessFormChildData(childDefKey, ChildDataKey, Data);
            logger.fine("Exiting OIMForms.updateProcessFormChildValue()");
        } catch (tcFormNotFoundException ex) {
            logger.log(Level.SEVERE,"tcFormNotFoundException",ex);
            throw new OIMHelperException("tcFormNotFoundException",ex);
        } catch (tcFormEntryNotFoundException ex) {
            logger.log(Level.SEVERE,"tcFormEntryNotFoundException",ex);
    ...
    public void removeProcessDataChildValue(long ProcessInstanceKey, String ChildTable, long ChildDataKey) throws OIMHelperException {
        ...
        logger.fine("Entering OIMForms.removeProcessDataChildValue()");
        long childDefKey = getChildFormDefKey(ProcessInstanceKey, ChildTable);
        try {
        ...
        logger.fine("Exiting OIMForms.removeProcessDataChildValue()");
    }
    ...
    public boolean isITResourceField(long ProcessInstanceKey, String Field) throws OIMHelperException {
        ...
        logger.fine("Entering OIMForms.isITResourceField()");
        int formVersion;
        try {
            formVersion = getFormVersion(ProcessInstanceKey);
        } catch (OIMHelperException ex) {
            logger.log(Level.SEVERE,"isITResourceField/getFormVersion");
            throw ex;
        }
        long formDefKey = 0l;
        try {
        ...
        try {
            ...
            logger.log(Level.SEVERE,"isITResourceField/isFieldType");
            throw ex;
        }
        logger.fine("Exiting OIMForms.isITResourceField()");
        return result;
    }
    ...
    public boolean isPasswordField(long ProcessInstanceKey, String Field) throws OIMHelperException {
        ...
        logger.fine("Entering OIMForms.isPasswordField()");
        int formVersion = 0;
        try {
            formVersion = getFormVersion(ProcessInstanceKey);
        } catch (OIMHelperException ex) {
            logger.log(Level.SEVERE,"isPasswordField/getFormVersion");
            throw ex;
        }
        long formDefKey = 0l;
        try {
        ...
        try {
            ...
            logger.log(Level.SEVERE,"isPasswordField/isFieldType");
            throw ex;
        }
        logger.fine("Exiting OIMForms.isPasswordField()");
        return result;
    }
    ...
    public boolean isEncryptedField(long ProcessInstanceKey, String Field) throws OIMHelperException {
        ...
        logger.fine("Entering OIMForms.isEncryptedField()");
        boolean result = false;
        int formVersion;
        try {
            formVersion = getFormVersion(ProcessInstanceKey);
        } catch (OIMHelperException ex) {
            logger.log(Level.SEVERE,"isEncryptedField/getFormVersion");
            throw ex;
        }
        try
        {
        ...
        logger.fine("Exiting OIMForms.isEncryptedField()");
        return result;
    ...
    public boolean isDateField(long ProcessInstanceKey, String Field) throws OIMHelperException {
        try {
            logger.fine("Entering OIMForms.isDateField()");
            int formVersion = getFormVersion(ProcessInstanceKey);
            long formDefKey = formInstOp.getProcessFormDefinitionKey(ProcessInstanceKey);
    ...
    public Map getProcessFormDisplayNames(long ProcessInstanceKey) throws OIMHelperException {
        ...
        logger.fine("Entering OIMForms.getProcessFormDisplayNames()");
        Map result = new HashMap();
        int formVersion;
        try {
            formVersion = getFormVersion(ProcessInstanceKey);
        } catch (OIMHelperException ex) {
            logger.log(Level.SEVERE,"getProcessFormDisplayNames/getFormVersion");
            throw ex;
        }
        ...
        logger.fine("Exiting OIMForms.getProcessFormDisplayNames()");
        return result;
