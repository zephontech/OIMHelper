...
public class OIMProperties extends BaseHelper {
    ...
    private static final Logger logger = Logger.getLogger(OIMProperties.class.getName());
    ...
    public OIMProperties() throws OIMHelperException {
        ...
        if (scheduleOps == null) {
            logger.log(Level.SEVERE,"Failed to get scheduleOps");
            throw new OIMHelperException("scheduleOps Failed");
        }
        if (confService == null) {
            logger.log(Level.SEVERE,"Failed to get confService");
    ...
    public Map<String, String>  getITResourceProperties(String itResourceName) throws OIMHelperException {
        ...
        try {
            ...
            {
                logger.log(Level.SEVERE,"ITResource " + itResourceName + " not found");
            ...
            for (int i = 0; i < rst.getTotalRowCount(); i++) {
                ...
                //logger.fine("ITResource Parms: " + srchMap);
            }
            logger.info("Finished Retrieving ITResource parameters");
        } catch (tcAPIException e) {
            logger.log(Level.SEVERE,"tcAPIException while retrieving ITResource parameters: " + e.getMessage(), e);
            throw new OIMHelperException(e);
        } catch (tcColumnNotFoundException e) {
            logger.log(Level.SEVERE,"tcColumnNotFoundException while retrieving ITResource parameters: " + e.getMessage(), e);
            throw new OIMHelperException(e);
        } catch (tcITResourceNotFoundException e) {
            logger.log(Level.SEVERE,"tcITResourceNotFoundException while retrieving ITResource parameters: " + e.getMessage(), e);
            throw new OIMHelperException(e);
        }
        return resourceMap;
    }
    ...
    public Map<String, String> getLookupProperties(String lookupName) throws OIMHelperException {
        ...
        try {
            ...
            if (amRow == 0) {
                logger.log(Level.SEVERE,"Lookup Code " + lookupName + " not found");
            ...
            logger.log(Level.SEVERE,"tcAPIException ", e);
            throw new OIMHelperException(e);
        } catch (tcInvalidLookupException e) {
            logger.log(Level.SEVERE,"tcInvalidLookupException ", e);
            throw new OIMHelperException(e);
        } catch (tcColumnNotFoundException e) {
            logger.log(Level.SEVERE,"tcColumnNotFoundException ", e);
            throw new OIMHelperException(e);
        }
    ...
    public String getSystemProperty(String propName) throws OIMHelperException {
        ...
        try {
            ...
            logger.log(Level.SEVERE,"SystemConfigurationServiceException",SCSE);
