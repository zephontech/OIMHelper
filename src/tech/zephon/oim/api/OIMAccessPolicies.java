 ...
 */
public class OIMAccessPolicies {

    private AccessPolicyService accessPolicyService;
    
    
    public OIMAccessPolicies(AccessPolicyService accessPolicyService) {
        this.accessPolicyService = accessPolicyService;
    }

    public OIMAccessPolicies(OIMClient client) {
    ...
    public AccessPolicy getAccessPolicy(String accessPolicyName) throws AccessPolicyServiceException {
        ...
        SearchCriteria searchCriteriaPolicyName = new SearchCriteria(AccessPolicy.ATTRIBUTE.NAME.getID(), accessPolicyName, SearchCriteria.Operator.EQUAL);
    ...
    /**
     * @return @throws AccessPolicyServiceException
     */
