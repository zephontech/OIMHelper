...
public final class OIMlookupUtilities extends BaseHelper {
    ...
    private static final Logger logger = Logger.getLogger(OIMlookupUtilities.class.getName());
    /**
    ...
    public OIMlookupUtilities(OIMClient client) throws OIMHelperException {
        ...
        if (lookupOp == null) {
            logger.log(Level.SEVERE,"Failed to get lookupOps");
    ...
    public Map<String,String> getLookupValues(String Lookup) throws OIMHelperException {
        logger.fine("Entering OIMlookupUtilities.getLookupValues()");
        ...
        logger.fine("Exiting OIMlookupUtilities.getLookupValues()");
        return result;
    }
    ...
    public String getLookupValue(String Key, String Lookup) throws OIMHelperException {
        logger.fine("Entering OIMlookupUtilities.getLookupValue()");
        String result = "";
        ...
        try
        {
            ...
            for (int i = 0; i < results.getRowCount(); i++) {
                ...
                if (results.getStringValue("Lookup Definition.Lookup Code Information.Code Key").equalsIgnoreCase(Key)) {
                    logger.fine(Key + " was found in the lookup table");
        ...
        logger.fine("Exiting OIMlookupUtilities.getLookupValue()");
        return result;
    }
    ...
    public String[] getLookupKeys(String Value, String Lookup) throws OIMHelperException {
        logger.fine("Entering OIMlookupUtilities.getLookupKeys()");
        ...
        try
        {
            ...
            for (int i = 0; i < results.getRowCount(); i++) {
                ...
                if (results.getStringValue("Lookup Definition.Lookup Code Information.Decode").equalsIgnoreCase(Value)) {
                    logger.fine(Value + " was found in the lookup table");
        ...
        logger.fine("Exiting OIMlookupUtilities.getLookupKeys()");
    ...
    public void addLookupValue(String Key, String Value, String Lookup) throws OIMHelperException {
        logger.fine("Entering OIMlookupUtilities.addLookupValue()");
        try
        {
        ...
        logger.fine("Exiting OIMlookupUtilities.addLookupValue()");
    }
    ...
    public void updateLookupValue(String Key, String Value, String Lookup, boolean ExactMatch) throws OIMHelperException {
        logger.fine("Entering OIMlookupUtilities.updateLookupValue()");
        ...
        logger.fine("Exiting OIMlookupUtilities.updateLookupValue()");
    }
    ...
    public void removeLookupValue(String Key, String Lookup, boolean ExactMatch) throws OIMHelperException {
        logger.fine("Entering OIMlookupUtilities.removeLookupValue()");
        ...
        logger.fine("Exiting OIMlookupUtilities.removeLookupValue()");
    }
    ...
    public void createLookup(String Lookup) throws OIMHelperException {
        ...
        logger.fine("Entering OIMlookupUtilities.createLookup()");
        try
        {
        ...
        {
            logger.log(Level.SEVERE,"Table Already Exists");
        }
        logger.fine("Exiting OIMlookupUtilities.createLookup()");
    }
    ...
    public void clearLookup(String Lookup) throws OIMHelperException {
        logger.fine("Entering OIMlookupUtilities.clearLookup()");
        try
        {
            tcResultSet results = lookupOp.getLookupValues(Lookup);
            for (int i = 0; i < results.getRowCount(); i++) {
        ...
        logger.fine("Exiting OIMlookupUtilities.clearLookup()");
    }
    ...
    public void removeLookup(String Lookup) throws OIMHelperException {
        logger.fine("Entering OIMlookupUtilities.removeLookup()");
        try
        {
            //clearLookup(Lookup);
        ...
        logger.fine("Exiting OIMlookupUtilities.removeLookup()");
    }
}
