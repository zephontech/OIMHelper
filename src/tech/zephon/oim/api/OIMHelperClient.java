...
import tech.zephon.oim.oimutils.WebConfigLoader;
...
public class OIMHelperClient {
    ...
    private static final Logger logger = Logger.getLogger( OIMHelperClient.class.getName() );
    ...
    public void loginWithCustomEnv()  {
        ...
        logger.fine("APPSERVER_TYPE:" + type);
        if (type == null)
        ...
        try {
            ...
            logger.log(Level.SEVERE,"LoginException",ex);
    ...
    {
        logger.fine("Creating RM client....");
