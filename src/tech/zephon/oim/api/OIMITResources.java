...
public class OIMITResources extends BaseHelper {
    ...
    private static final Logger logger = Logger.getLogger( OIMITResources.class.getName() );
    /**
    ...
    public long getItResource(String Name) throws OIMHelperException {
        logger.fine("Entering OIMITResources.getItResource()");
        long result = 0L;
        ...
        try {
            ...
            if (results.getRowCount() == 1) {
                ...
                logger.fine("Found " + Name + " = " + Long.toString(result));
            } else {
                logger.fine("Did not find an exact match for " + Name + "; beginning a slow search");
                searchFor.clear();
        ...
        logger.fine("Exiting OIMITResources.getItResource()");
        return result;
    }
    ...
    public String getItResource(long Key) throws OIMHelperException {
        ...
        try {
            ...
            if (results.getRowCount() == 1) {
                ...
                logger.fine("Found " + result + " = " + Long.toString(Key));
            }
        } catch (tcAPIException e) {
            throw new OIMHelperException(e);
        } catch (tcColumnNotFoundException e) {
    ...
    {
        List fieldList = null;
        logger.fine("Entering getITResourceDefinitionParameters()");
        try {
            ...
            if (results.getRowCount() > 0 ) {
                ...
                {
                    logger.fine("ColName " + colNames[i]);
                }
        ...
        logger.fine("Exiting getITResourceDefinitionParameters()");
        return fieldList;
    }
    ...
    public long getItResourceDefinition(String Type) throws OIMHelperException {
        logger.fine("Entering OIMITResources.getItResourceDefinition()");
        long result = 0L;
        Map searchFor = new HashMap();
        ...
        try {
            ...
            if (results.getRowCount() == 1) {
                ...
                logger.fine("Found " + Type + " = " + Long.toString(result));
            } else {
                logger.fine("Did not find an exact match for " + Type + "; beginning a slow search");
                searchFor.clear();
        ...
        logger.fine("Exiting OIMITResources.getItResourceDefinition()");
        return result;
    }
    ...
    public Map getITResData(long InstanceKey, boolean HideEncrypted) throws OIMHelperException {
        logger.fine("Entering OIMITResources.getITResData()");
        ...
        logger.fine("Exiting OIMITResources.getITResData()");
        return result;
    }
    ...
    public Map[] getITResOfType(long ITResourceDefintionKey) throws OIMHelperException {
        logger.fine("Entering OIMITResources.getITResOfType()");
        ...
        logger.fine("Exiting OIMITResources.getITResOfType()");
    ...
    public void updateITResource(long ITResourceKey, Map Data) throws OIMHelperException {
        logger.fine("Entering OIMITResources.updateITResource()");
        try {
        ...
        logger.fine("Exiting OIMITResources.updateITResource()");
    }
    ...
    public void createITResource(String Name, long DefinitionKey, Map Data) throws OIMHelperException {
        logger.fine("Entering OIMITResources.createITResource()");
        ...
        logger.fine("Exiting OIMITResources.createITResource()");
    }
    ...
    public void removeITResource(long ITResourceKey) throws OIMHelperException {
        logger.fine("Entering OIMITResources.removeITResource()");
        try {
        ...
        logger.fine("Exiting OIMITResources.removeITResource()");
    }
    ...
    public Map getAllITResources() throws OIMHelperException {
        ...
        try {
            ...
            for(int i=0;i<results.getRowCount();i++) {
                ...
                logger.fine("Found " + name + " = " + Long.toString(lKey));
                resMap.put(key, name);
            }
        } catch (tcAPIException e) {
            throw new OIMHelperException(e);
    ...
    public void printResourceParms(long resourceKey,String resName) throws OIMHelperException
    {
        ...
        try {
            ...
            logger.log(Level.SEVERE,"tcITResourceNotFoundException",ex);
